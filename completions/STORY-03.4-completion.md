...
- [x] Canonical infrastructure injection hook created (template) -- `.claude/hooks/canonical-infra-inject.sh` and `.claude/hooks/canonical-infra-inject.config` created; template facts file at `project/data/canonical-facts.md`
...
- `project/data/canonical-facts.md` -- Created template for canonical infrastructure facts

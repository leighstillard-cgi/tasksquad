...
- [x] Index wiki content -- `wiki/wiki.md` and `wiki/standards/database-conversion.md` included in graph
...
- [x] Index guides -- `guides/conversion-patterns-guide.md` extracted with ASE-to-MSSQL conversion patterns

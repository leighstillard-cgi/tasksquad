...
**Files changed:**
- `dashboard/internal/handlers/handlers.go` — input validation, stdlib usage
- `dashboard/internal/handlers/markdown.go` — XSS fix (goldmark WithXHTML)
- `dashboard/internal/handlers/websocket.go` — origin validation
- `dashboard/main.go` — security headers middleware
- `dashboard/templates/index.html` — template XSS fix (|js filter)
- `dashboard/.gitignore` — new file
...
**Audit Report:** `security-audits/mcp-server-audit-sybase.md`
...
**Audit Report:** `security-audits/mcp-server-audit-mssql.md`
...
- [x] Sybase MCP audit completed — `security-audits/mcp-server-audit-sybase.md`
- [x] Sybase MCP fixes implemented — SqlValidator class added
- [x] MSSQL MCP audit completed — `security-audits/mcp-server-audit-mssql.md`
...
### TaskSquad repo
- `security-audits/mcp-server-audit-sybase.md` — new audit report
- `security-audits/mcp-server-audit-mssql.md` — new audit report
- `dashboard/internal/handlers/handlers.go` — security fixes
- `dashboard/internal/handlers/markdown.go` — XSS fix
- `dashboard/internal/handlers/websocket.go` — origin validation
- `dashboard/main.go` — security headers
- `dashboard/templates/index.html` — template XSS fix
- `dashboard/.gitignore` — new file

...
Continue work in `core/dashboard/` directory.
...
- Watch: dispatch-log.md, backlog.md, data/completions/, data/escalations/, data/dispatches/, data/session-logs/
...
- `core/dashboard/internal/handlers/handlers.go` — existing refresh loop to extend
- `data/story-specs/STORY-00.2-live-updates.md` — full spec

## Completion Output

Write to: `data/completions/STORY-00.2-completion.md`

...
- Rebuild command: `/graphify data/wiki data/guides data/standards core/docs/standards core/templates --update`

**STORY-03.6** (Claude-Mem):
- claude-mem plugin documented in `data/project/tooling.md`
...
1. **core/scripts/install.sh** should:
...
2. **core/scripts/post-setup.sh** should:
...
Write completion report to: `data/completions/STORY-03.8-completion.md`

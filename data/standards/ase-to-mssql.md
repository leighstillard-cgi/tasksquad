...
2. `data/guides/conversion-patterns-guide.md` (syntax-level transformation patterns)
3. The assigned story spec in `data/story-specs/`
...
|---|---|---|
| This document (`data/standards/ase-to-mssql.md`) | Rules, process, quality gates, escalation triggers | Before every conversion |
| `data/guides/conversion-patterns-guide.md` | Syntax-level ASE → MS SQL transformation patterns | Before every conversion, during conversion |
| `core/templates/conversion-story.md` | Story spec format for individual conversions | When the PM creates new stories |

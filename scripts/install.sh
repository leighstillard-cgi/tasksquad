...
#
# Usage: ./install.sh [--skip-rtk] [--skip-graphify] [--skip-lasso]
...
- [ ] **Populate canonical-facts.md** - Add project-specific facts to \`~/.claude/canonical-facts.md\`
...
1. Run \`./scripts/post-setup.sh\` after adding your content
...
echo "   Edit ~/.claude/canonical-facts.md with project facts"
echo ""
echo "4. (Optional) Install lasso-security hooks:"
echo "   https://github.com/lasso-security/claude-hooks"
echo ""
echo "Run ./scripts/post-setup.sh after adding content to rebuild indexes."
echo ""

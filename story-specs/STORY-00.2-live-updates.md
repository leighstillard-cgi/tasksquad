...
- `dashboard/README.md` — current architecture
- `dashboard/internal/handlers/handlers.go` — existing refresh loop
- `completions/STORY-00.1-completion.md` — example completion report format
- `session-logs/` — example session log format
...
**Server-side:**
- Add `fsnotify` watcher on worklog directories: `dispatch-log.md`, `backlog.md`, `completions/`, `escalations/`, `dispatches/`, `session-logs/`
...
- Only serve files from expected directories (completions/, session-logs/)
